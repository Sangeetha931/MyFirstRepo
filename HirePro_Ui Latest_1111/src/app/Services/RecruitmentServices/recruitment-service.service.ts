...
export class RecruitmentServiceService {
  ...
  private getInterviewScheduleByCandiateIdAndRecStatusUrl = 
    this.baseUrl + 'getInterviewScheduleByCandiateIdAndRecStatus';
  ...
  getInterviewScheduleByCandiateIdAndRecStatus(id: string, recStatus : string){
    return this.httpClient.get<interviewSchedule>(
      `${this.getInterviewScheduleByCandiateIdAndRecStatusUrl}/${id}/${recStatus}`,
      {
        headers: {
          'pro-api-key': 'h1r5pr0',
          'Content-Type': 'application/json',
