...
//			interviewScheduleOld.setUpdatedDateTime(LocalDateTime.now());
	...
	@Override
	public InterviewScheduleDto getInterviewScheduleByCandidateIdAndRecStatus(final String candiateId, final String recStatus) throws Exception {

		InterviewSchedule interviewSchedule = interviewScheduleRepository.findByCandidateIdAndRecStatus(Long.parseLong(candiateId), recStatus);
