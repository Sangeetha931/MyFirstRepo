...
public class BusinessUnitServiceImpl implements BusinessUnitService {
	...
	public BusinessUnitDto addBusinessUnit(final BusinessUnitDto businessUnitDto, String lang) throws Exception {
		...
		if (this.checkBUName(businessUnitDto.getBusinessUnitName())) {
	...
	@Override
	public Boolean checkBUName(String buName) throws Exception {

		if (businessUnitRepository.getBusinessUnitByBusinessUnitNameIgnoreCase(buName) != null) {
			return true;
		}
